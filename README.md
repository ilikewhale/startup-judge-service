...
| <div style="width: 160px; text-align: center;">창업자 평판 에이전트 구현, 전체 flow chart 도면 구성</div> | <div style="width: 160px; text-align: center;">시장성 분석 에이전트 구현, 전체 flow chart 도면 구성</div> | <div style="width: 160px; text-align: center;">법적/규제 리스크 분석 에이전트 구현, 비동기 전체 flow 구성</div> | <div style="width: 160px; text-align: center;">스타트업탐색, 투자판단, 보고서 생성 에이전트 구현, 비동기 전체 flow 구성</div> | <div style="width: 160px; text-align: center;">경쟁사 비교 에이전트 구현, 비동기 전체 flow 구성</div> | <div style="width: 160px; text-align: center;">기술 요약 에이전트 구현, 에이전트 별 flow chart 도면 구성 및 리드미 작성</div> |
